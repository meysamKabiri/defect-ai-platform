...
const uploadProgressSlice = createSlice({
  ...
  reducers: {
    ...
    setUploadStatus: (state, action: PayloadAction<UploadProgressState['status']>) => {
...
export const { resetUploadProgress, setUploadProgress, setUploadStatus } = uploadProgressSlice.actions
